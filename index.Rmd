...
--
  ...
  - **Univariate analysis:** T-test, ANOVA, ANCOVA, Wilcoxon rank-sum test, and Kruskal Wallis
...
--
  ...
  - **Regularization methods:** LASSO, Ridge regression, and Elasticnet (**allow train/test split**)
...
.center[
.textboxorange-big[All `POMA` functions are focused on simplifying and compacting analysis, grouping different methodologies of the same class within a single function instead of maintaining "single purpose" functions]
]
